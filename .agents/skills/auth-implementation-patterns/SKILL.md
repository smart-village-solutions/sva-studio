...
- Wenn Auth-Aenderungen Architektur, Trust Boundaries oder Session-/Token-Flows wesentlich beeinflussen, aktualisiere die betroffenen arc42-Abschnitte unter `docs/architecture/` (Einstiegspunkt: `docs/architecture/README.md`) und referenziere (oder ergaenze) passende ADRs unter `docs/adr/`.
