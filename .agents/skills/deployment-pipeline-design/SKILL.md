...
- Wenn Pipeline-/Deployment-Aenderungen die Laufzeit- oder Deployment-Sicht wesentlich veraendern, dokumentiere die betroffenen arc42-Abschnitte unter `docs/architecture/` (Einstiegspunkt: `docs/architecture/README.md`) und halte Entscheidungen als ADRs unter `docs/adr/` fest.
