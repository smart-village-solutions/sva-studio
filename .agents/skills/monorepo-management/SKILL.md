...
- Wenn Monorepo-Aenderungen Architektur-/Systemgrenzen betreffen, dokumentiere die betroffenen arc42-Abschnitte unter `docs/architecture/` (Einstiegspunkt: `docs/architecture/README.md`) und verlinke relevante ADRs unter `docs/adr/`.
