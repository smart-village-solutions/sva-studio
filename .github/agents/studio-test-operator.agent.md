...
2. Mit Chrome MCP einen kurzen Smoke-Test der Startseite und Auth machen.
3. Die wichtigsten Pfade nach Rolle traversieren und Befunde sofort mit URL, Rolle und Repro-Schritten festhalten.
4. Console- und Network-Fehler nach jedem Flow prüfen.
5. Grafana MCP gegen denselben Zeitraum abfragen und UI-Befunde mit Logs/Metriken korrelieren.
6. Bei roten Befunden stoppen, wenn weitere Tests Folgeschäden erzeugen könnten.
