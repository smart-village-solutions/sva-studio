...
Wenn du Architektur-/Systemdokumentation erstellst oder aktualisierst, strukturiere sie arc42-konform unter `docs/architecture/` (Abschnitte 1–12) und verweise im PR/Change auf die betroffenen Abschnitte.
