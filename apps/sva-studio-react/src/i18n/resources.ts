  ...
  de: {
    ...
    account: {
      ...
      messages: {
        ...
        emailUpdateFinished: 'Die E-Mail-Änderung wurde abgeschlossen.',
        emailUpdateUnavailable: 'Die E-Mail-Änderung ist in dieser Keycloak-Umgebung derzeit nicht verfügbar.',
  ...
  en: {
    ...
    account: {
      ...
      messages: {
        ...
        emailUpdateFinished: 'The email change was completed.',
        emailUpdateUnavailable: 'Email change is currently unavailable in this Keycloak environment.',
        accountActionCancelled: 'The action was cancelled.',
