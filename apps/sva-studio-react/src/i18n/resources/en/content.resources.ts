export const contentENResources = {
  ...
  ownership: {
    ...
    targetPlaceholder: 'Select an account or organization…',
    search: 'Search accounts or organizations',
    ...
    refineSearch: 'More results are available. Refine your search to narrow them down.',
