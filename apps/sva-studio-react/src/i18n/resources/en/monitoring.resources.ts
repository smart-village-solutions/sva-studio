export const monitoringENResources = {
  ...
  jobs: {
    ...
    detail: {
      ...
      liveProgressBatch: 'Current batch: {{current}} / {{total}}',
      liveProgressProcessed: 'Processed records: {{current}} / {{total}}',
      liveProgressLastActivity: 'Last activity: {{value}}',
      liveProgressLastSuccessfulBatch: 'Last successful batch: {{value}}',
      liveProgressLikelyStuck:
        'The run likely looks stuck because no fresh progress has been reported since the last successful batch.',
