...
export const applySchemaStatements = (schemaName: string): readonly string[] => {
  ...
  return [
    ...
    `ALTER TABLE ${schema}.waste_cities ADD COLUMN IF NOT EXISTS postal_code TEXT;`,
    ...
    `ALTER TABLE ${schema}.waste_tours ALTER COLUMN status DROP DEFAULT;`,
    ...
    `CREATE TABLE IF NOT EXISTS ${schema}.waste_settings (id BOOLEAN PRIMARY KEY DEFAULT TRUE, pdf_branding_asset_url TEXT, pdf_contact_block TEXT, disruption_location_enabled BOOLEAN NOT NULL DEFAULT FALSE, disruption_all_locations_enabled BOOLEAN NOT NULL DEFAULT FALSE, created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), CONSTRAINT waste_settings_singleton_check CHECK (id = TRUE));`,
    `ALTER TABLE ${schema}.waste_settings ADD COLUMN IF NOT EXISTS disruption_location_enabled BOOLEAN NOT NULL DEFAULT FALSE;`,
    `ALTER TABLE ${schema}.waste_settings ADD COLUMN IF NOT EXISTS disruption_all_locations_enabled BOOLEAN NOT NULL DEFAULT FALSE;`,
