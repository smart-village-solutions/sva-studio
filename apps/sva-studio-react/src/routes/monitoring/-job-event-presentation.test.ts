...
describe('monitoring job event presentation', () => {
  ...
  it('provides shared status and progress presentation helpers for monitoring pages', () => {
    ...
    expect(formatMonitoringJobDateTime('2026-01-15T10:15:00.000Z')).toBe('15.01.2026, 11:15');
    expect(formatMonitoringJobDateTime('2026-07-15T10:15:00.000Z')).toBe('15.07.2026, 12:15');
    expect(
      formatMonitoringJobProgressSummary({
        completedSteps: 2,
        totalSteps: 5,
