...
- Asynchrone Keycloak-Aufträge tragen die von der App validierten Plugin-OIDC-Anforderungen als unveränderlichen Queue-Snapshot. Der getrennte Provisioner verwendet diesen Snapshot unverändert; fehlende Snapshots brechen vor der Ausführung fail-closed ab.
