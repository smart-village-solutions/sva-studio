...
- Neue asynchrone Keycloak-Aufträge tragen die von der App validierten Plugin-OIDC-Anforderungen als versionierten, unveränderlichen Queue-Snapshot. Der getrennte Provisioner verwendet diesen Snapshot unverändert. Unversionierte oder unvollständige Aufträge brechen vor der Ausführung fail-closed ab und müssen deshalb vor dem Versionswechsel mit dem bisherigen Worker geleert werden.
