...
22. Besitzt der Redakteur `waste-management.read`, lädt der News-Editor aktive Abholorte über die Waste-Master-Data-Fassade. Die UI hält IDs nur für Filterung und Auswahl; beim Speichern dedupliziert der Adapter stabile Adressschlüssel und führt sie verlustfrei mit dem vorhandenen News-Payload zusammen. Ohne Ziele fehlt `wasteLocationKeys`; bei einem tatsächlich ausgelösten Push bestätigt der Redakteur diesen globalen Zustand ausdrücklich.
