...
12. Die Fachlisten und Detailseiten unter `/admin/news`, `/admin/events`, `/admin/poi` und `/admin/generic-items` rufen weiterhin ihre jeweiligen Host-Fassaden auf: `/api/v1/mainserver/news`, `/api/v1/mainserver/events`, `/api/v1/mainserver/poi` oder `/api/v1/mainserver/generic-items`.
