...
- **Legacy-Seed-Grenze:** Staging und Production akzeptieren bei vorhandenem Live-Digest keinen mutierenden Promote ohne gültige, gleichzeitig erfasste `sva.config.revision` – weder bei Digestwechsel noch bei Same-Digest und weder im Standard- noch im Recovery-Modus. Ein Übergang benötigt einen separat geprüften Plan; der Workflow erzeugt keinen stillen Seed. Dev bleibt im Standardmodus disposable.
