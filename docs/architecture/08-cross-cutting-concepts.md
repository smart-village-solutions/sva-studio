...
- Der persistierte Queue-Schritt bindet jeden Run an den in der App validierten Plugin-OIDC-Snapshot. Fehlende oder ungültige Snapshots werden vor Keycloak-Zugriff abgewiesen; ein expliziter Queue-Snapshot hat an der Provisioner-Grenze Vorrang vor Prozessdefaults.
