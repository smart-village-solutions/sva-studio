...
- **Kanonischer Auth-Host:** OIDC-Flows laufen ausschließlich über die Root-Domain. Auth-Cookies werden auf die Parent-Domain gesetzt (`Domain=.<SVA_PARENT_DOMAIN>`) für SSO über Instanz-Subdomains.
