...
- Der Runtime-Doctor prüft für Remote-Profile ein rollierendes 15-Minuten-Loki-Fenster auf Keycloaks Warnung zum unsicheren Cookie-Kontext. Jeder Treffer macht `observability-readiness` fail-closed rot; vor einem grünen Ergebnis werden leere Loki-Antworten begrenzt wiederholt, um Ingestion-Lag abzudecken. Diagnoseausgaben enthalten nur Treffer-Untergrenze, Abfragelimit und Fenstergröße, niemals die Logzeile.
