...
- V1 leitet Inaktivität für Tenant-Löschregeln ausschließlich aus `MAX(iam.activity_logs.created_at WHERE event_type = 'login')` pro `instanceId` ab; neue Aktivitätstelemetrie gehört nicht zu diesem Scope.
