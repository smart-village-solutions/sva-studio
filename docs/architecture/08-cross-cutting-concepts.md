...
- Surveys laufen produktiv über denselben hostgeführten Mainserver-Pfad: Liste, Detail, Upsert, Freitext-Freigabe, Freitext-Loeschung und Ergebnisabruf bleiben serverseitig gekapselt; das Plugin konsumiert nur hostkontrollierte HTTP-/SDK-Verträge.
