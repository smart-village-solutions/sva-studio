...
- Eine konfliktbehaftete persönliche Bindung darf sich nur anlassbezogen selbst heilen, wenn frische Identity-Evidenz den aktuellen Benutzer bestätigt und alle konkurrierenden Principals endgültig gelöschte oder nach Hard Delete nicht mehr vorhandene Benutzer sind. Die Runtime historisiert deren Evidenz und verifiziert die aktuelle Bindung atomar; sie löscht keine Zeile, behauptet keinen Credential-Widerruf und führt bei aktiven, reversibel inaktiven, organisatorischen oder unklaren Konkurrenten keinen Übergang aus.
