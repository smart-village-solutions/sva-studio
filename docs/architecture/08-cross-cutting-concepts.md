...
- Surveys laufen produktiv über denselben hostgeführten Mainserver-Pfad: Liste, Detail, Upsert, Freitext-Freigabe, Freitext-Löschung und Ergebnisabruf bleiben serverseitig gekapselt; das Plugin konsumiert nur hostkontrollierte HTTP-/SDK-Verträge.
