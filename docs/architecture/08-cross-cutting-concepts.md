...
- Der explizite IAM-Baseline-Reconcile persistiert die Core-Basis und alle bekannten Modulverträge auch dann, wenn einer historischen Modulzuweisung der Vertrag fehlt. Der fehlende Vertrag bleibt mit `unknown_module_contract:<moduleId>` sichtbar und erhält keine erfundenen Rechte; normale Modulzuweisung, Modulentzug und Admin-Bootstrap bleiben dagegen vollständig atomar und fail-closed.
