...
| Host: Inhaltsliste                                             | Einzel- und Bulk-Löschung von Mainserver-Inhalten; serverseitig Tombstone beziehungsweise Provider-Löschung | derzeit `window.confirm`                                           | namespaced `*.delete`, Principal- und Scope-Prüfung           | aktualisierte Liste; bestehende lokale Mutationsfehler                                 | Folgemigration                                                 |
