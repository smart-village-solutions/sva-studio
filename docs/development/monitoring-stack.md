...
2. Start:
   - Kombiniertes Setup: `docker compose -f docker-compose.yml -f compose.monitoring.yaml up -d`
3. Health-Checks:
...
- `docker compose -f docker-compose.yml -f compose.monitoring.yaml up -d`
