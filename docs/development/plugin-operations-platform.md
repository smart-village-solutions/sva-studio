...
- meldet ein Plugin einen retryable Lifecycle-Fehler ohne eigene Deadline, persistiert der Host einen 60-sekündigen Default-Backoff; Worker und Read-Model verwenden dieselbe Deadline und starten keine unmittelbare neue Jobgeneration
