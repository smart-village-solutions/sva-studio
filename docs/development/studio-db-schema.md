...
- Schlägt die IAM-Synchronisierung nach einer manuellen Aktivierungsänderung fehl, stellt der Repository-Rollback den zuvor gelesenen Aktivierungsursprung, den wirksamen Zustand und die manuelle Übersteuerung revisionsgebunden wieder her; eine zuvor automatisch aktive Zuordnung wird dadurch nicht versehentlich deaktiviert.
