...
| Aufbewahrung und Löschung | PII fristgerecht anonymisieren und Auditdaten archivieren | Speicherbegrenzung, DSGVO-konformer Lifecycle | Engineering, Plattform, Datenschutz | täglich, monatlich | `docs/operations/iam-retention-automation.md`, Runtime-Logs |
...
| Incident-Bearbeitung | Eskalationspfade für Datenschutz-/Governance-Vorfälle definieren | schnelle Reaktion und dokumentierte Behandlung | Security, Datenschutz, Plattform | anlassbezogen, quartalsweise | `docs/governance/security-policy.md`, `docs/governance/iam-governance-runbook.md` |
