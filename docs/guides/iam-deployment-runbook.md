...
1. **Migrationen ausrollen**
   ...
   - produktionsnahe Remote-Profile führen diese Migrationen ausschließlich über GitHub Actions `Promote` mit `migration_mode=run` aus; Reihenfolge, Backup und Freigaben stehen im [kanonischen Studio-Rollout](./studio-rollout-process.md)
