...
5. Erst bei erklärten beziehungsweise behobenen Shadow-Abweichungen `automatic` aktivieren. Dev, Staging und Production folgen dem regulären Build- und Same-Digest-Rolloutprozess.
