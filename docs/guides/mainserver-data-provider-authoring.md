...
- Meldet die Identity-Prüfung einen Konflikt und gehören alle konkurrierenden aktuellen Bindungen ausschließlich zu endgültig gelöschten oder nach Hard Delete nicht mehr vorhandenen Benutzern, löst Studio diesen Zustand im selben Request automatisch auf: Die alten Bindungen werden `historical`, die bestätigte aktuelle Bindung wird `verified` und die noch nicht an den Mainserver gesendete Mutation läuft weiter.
