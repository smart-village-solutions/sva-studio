...
1. **Migrationen ausrollen**
   ...
   - produktionsnahe Remote-Profile führen diese Migrationen ausschließlich über GitHub Actions `Promote` mit `migration_mode=run` aus; Reihenfolge, Backup und Freigaben stehen im [kanonischen Studio-Rollout](../guides/studio-rollout-process.md)
...
- `docs/operations/instance-keycloak-provisioning.md`
- `docs/operations/keycloak-service-account-setup-iam.md`
- `docs/operations/keycloak-tenant-realm-bootstrap.md`
- `docs/operations/iam-acceptance-runbook.md`
- `docs/operations/iam-alerting-konzept.md`
- `docs/operations/iam-retention-automation.md`
