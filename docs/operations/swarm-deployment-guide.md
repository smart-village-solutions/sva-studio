...
Dieses Dokument beschreibt die technische Swarm-Grundlage und das nicht produktive Demo-Profil. Es ist keine Anleitung für reguläre Rollouts nach Dev, Staging oder Production. Dafür gilt ausschließlich der [kanonische Studio-Rollout](../guides/studio-rollout-process.md).
...
Die verbindlichen Namen und Domains stehen im [kanonischen Studio-Rollout](../guides/studio-rollout-process.md). Netzwerk-IDs dürfen nie aus älteren Reports übernommen werden; maßgeblich sind Name und aktuelle Live-ID am Zielendpoint.
...
- Regulärer Studio-Rollout: [`studio-rollout-process.md`](../guides/studio-rollout-process.md)
