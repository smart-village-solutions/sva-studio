...
Dieses Runbook beschreibt Infrastrukturprüfung, Diagnose, Restore und Incident-Recovery für die Studio-Swarm-Stacks. Der reguläre Rollout nach Dev, Staging und Production ist ausschließlich im [kanonischen Studio-Rollout](../guides/studio-rollout-process.md) definiert und wird durch GitHub Actions ausgeführt.
...
- Regulärer Rollout: [`studio-rollout-process.md`](../guides/studio-rollout-process.md)
