...
Neue Änderungen am Tenant-Admin-Client werden als normale Migration beziehungsweise Bootstrap-Risiken klassifiziert und ausschließlich nach dem [kanonischen Studio-Rollout](../guides/studio-rollout-process.md) erst nach Staging und anschließend mit demselben Digest nach Production befördert.
