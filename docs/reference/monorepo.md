...
- `tags`: `scope:core`, `scope:plugin-sdk`, `scope:plugin-contracts`, `scope:server-runtime` oder `scope:plugin-runtime`, plus `type:lib`
...
- Routing erfolgt über eine Code-Registry; siehe docs/reference/routing.md
