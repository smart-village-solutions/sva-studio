...
Mutationscontrols und ihre unabhängige Serverautorisierung sind unter [Servergrenze für scopegebundenen UI-Zugriff](./ui-access-server-enforcement.md) inventarisiert.
