...
- Die Zielauswahl unterscheidet verständlich zwischen „Persönlicher Account“ und „Organisation“ und findet beide Zieltypen über Namen. Die Account-Suche verwendet die tenantgebundene Keycloak-Suche und übernimmt ausschließlich lokal zugeordnete, aktive und zulässige Principals derselben Instanz; E-Mail-Adressen dürfen Suchschlüssel sein, werden aber nicht als Trefferinhalt angezeigt.
- Der bestätigte V1-Mainserver-Vertrag umfasst News, Events, POI, Touren und Root-GenericItems einschließlich der atomar mitgeführten abhängigen Datensätze. Das Studio aktiviert Transfers für die vorhandenen redaktionellen Adapter News, Events, POI und Root-GenericItems. Touren besitzen derzeit keinen redaktionellen Studio-Editor und erhalten deshalb keine tote Sonderintegration. Surveys, Batch-Importe und andere nicht bestätigte Typen bleiben capability-gated.
- Der Ablauf verwendet Fresh Pre-Read mit den Actor-Credentials, bestehende Mutation-Journale, DataProvider-Locks, Audit und Reconciliation. Ein unklarer Upstream-Ausgang wird durch Actor-/Target-Re-Reads geklärt oder als `reconciliation_required` markiert.
