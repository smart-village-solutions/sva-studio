...
- Sicherheits- und Contract-Härtung für mutierende Export-Operationen (`POST`, CSRF, `Idempotency-Key`) sowie striktere Legal-Text-Akzeptanz ohne Stammdaten-Mutation
- Verbindlicher Qualitätsnachweis: mindestens 90 Prozent Patch-Coverage für neuen und geänderten produktiven Code
