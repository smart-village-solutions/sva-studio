...
- [ ] 1.1 Neue Capability `public-waste-calendar` unter `openspec/changes/add-public-waste-calendar-web-app/specs/public-waste-calendar/spec.md` ausformulieren
- [ ] 1.2 Technisches Change-Design unter `openspec/changes/add-public-waste-calendar-web-app/design.md` aus dem abgestimmten Design-Spec ableiten
- [ ] 1.3 Betroffene arc42-Abschnitte identifizieren und für die spätere Implementierung als Pflichtupdates referenzieren
...
- [ ] 2.3 Serverseitige Bootstrapping- und Fehlerseitenpfade für fehlende oder ungültige Konfiguration spezifizieren
...
- [ ] 5.1 Teststrategie für Unit-, Integrations-, E2E- und Accessibility-Tests festschreiben
- [ ] 5.2 WCAG-2.1-AA-Ziele für Auswahlfluss, Kalender, Modal und iFrame-Einsatz als Pflichtanforderung festschreiben
- [ ] 5.3 Architektur- und Betriebsdokumentation in den referenzierten arc42-Abschnitten fortschreiben oder eine begründete Abweichung dokumentieren
