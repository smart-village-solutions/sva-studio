...
Der unter der bestätigten IAM-Revision persistierte Projektionszustand MUST
mindestens ein wirksam SSF-berechtigtes Subject enthalten. Der
Directory-Request MUST dafür den gemeinsamen technischen Readiness-Zustand und
den persistierten Projektionszustand verwenden und darf keine zusätzliche
Benutzerauflistung oder Projektion auslösen. Die Runtime-Readiness für
Gäste-Sessions bleibt von dieser zusätzlichen Directory-Voraussetzung
unberührt.
