...
Die bestehende Testlandschaft deckt deterministische App-Smokes und reproduzierbare IAM-Acceptance-Läufe ab, bietet aber keine eigene explorative Testschicht für reale lokale Admin-Flows. Für Rollen-, Rechte- und Benutzerverwaltung soll eine agentische Browser-Automation ergänzt werden, die echte IAM-/Backend-Pfade lokal erkundet, ohne die bestehenden Qualitätsgates zu destabilisieren.

## What Changes

- Einführung einer neuen Stagehand-basierten Explorationsschicht für lokale Admin-Journeys in `apps/sva-studio-react`
...
- Einführung eines Missionsmodells für erste Admin-Flows rund um Benutzer-, Rollen- und Rechteinspektion
- Erzeugung strukturierter Artefakte wie Missionsstatus, Bericht, Screenshots und Transcript
