...
- [x] 1.1 OpenSpec-Deltas für `account-ui`, `monorepo-structure`, `architecture-documentation` und `routing` finalisieren
- [x] 1.2 Wechselwirkung mit `refactor-p3-content-ui-specialization-boundaries` und `add-p2-admin-resource-host-standards` prüfen
...
- [x] 2.2 `docs/architecture/04-solution-strategy.md` um UI-Boundary und Plugin-Custom-View-Regel ergänzen
- [x] 2.3 `docs/architecture/05-building-block-view.md` um Baustein `packages/studio-ui-react` ergänzen
- [x] 2.4 `docs/architecture/06-runtime-view.md` um Laufzeitfluss für Plugin-Custom-Views mit `@sva/studio-ui-react` ergänzen
- [x] 2.5 `docs/architecture/08-cross-cutting-concepts.md` um Design-Tokens, shadcn-Kapselung und UI-Boundary ergänzen
- [x] 2.6 `docs/architecture/10-quality-requirements.md` und `11-risks-and-technical-debt.md` um UI-Drift- und Boundary-Risiken ergänzen
...
- [x] 5.4 App-interne Komponenten nur als Übergangsadapter behalten oder entfernen, soweit sie im Referenzpfad betroffen sind
...
- [x] 6.4 Spezialcontrols wie Rich-Text, Upload, Medienauswahl, Farbe, Icon und Geo-Auswahl nur bei pluginübergreifendem Bedarf aufnehmen
...
- [x] 8.3 Plugin-Entwicklungsleitfaden um `@sva/studio-ui-react`-Importregeln und Custom-View-Beispiele ergänzen
