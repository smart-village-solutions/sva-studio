...
- [ ] 4.1 Repository- und Migrationsintegrationstests für relevante Inserts, Updates, Deletes, Kaskaden, Bulk-Operationen, irrelevante Felder und monotone Revisionen ergänzen. Der echte PostgreSQL-Test `waste-mainserver-source-revision.postgres.integration.test.ts` deckt diese Fälle ab; seine lokale Ausführung war wegen nicht laufendem Docker-Daemon vor Teststart blockiert und muss im PR-Integration-Gate grün nachgewiesen werden.
- [x] 4.2 Runtime-Tests für konsistenten Quellsnapshot, Create-/Delete-Plan, Jobergebnis, parallele Änderungen, Legacy-Jobs, Fehler und Jahreswechsel ergänzen. Der gezielte Serverlauf einschließlich expliziter Repeatable-Read-Snapshot-Prüfung war am 27.08.2026 mit 15/15 Tests grün; Revisionsabweichung, Legacy-/Fehlerzustände und Jahresfenster sind zusätzlich in Core- und Loader-Tests abgedeckt.
