...
## arc42-Fortschreibung für Paket 5

Die Rechtstext- und Akzeptanzanforderungen dieses Changes wirken auf folgende arc42-Abschnitte:

- **05 Building Block View**
  - IAM-Middleware, Akzeptanzstatus-Prüfung und Audit-/Export-Bausteine als eigene Verantwortlichkeiten zwischen `packages/auth`, `packages/data` und `apps/sva-studio-react`
- **06 Runtime View**
  - Login-, Interstitial-, Export- und Logout-Abläufe für offene Pflichtakzeptanzen
- **08 Cross-Cutting Concepts**
  - Fail-Closed-Gates, blockierte Sessions, Zugriffsgates, i18n- und Accessibility-Vorgaben, Audit-Konsistenz
- **09 Architecture Decisions**
  - Rechtstext-Fail-Closed und blockierter Session-Zustand werden als explizite Architekturentscheidung geführt
- **10 Quality Requirements**
  - Nachweisbarkeit, Revisionssicherheit, Accessibility und eindeutige Fehlerkommunikation
- **11 Risks and Technical Debt**
  - Ausstehender IAM-Konfigurations-Export für Gruppen, Rollen, strukturierte Permissions und Org-/Geo-Hierarchie bleibt dokumentierte Folgearbeit
