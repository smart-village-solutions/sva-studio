...
- Content-Authorize-Requests muessen die kanonische IAM-Ownership (`ownerUserId`/`ownerOrganizationId` beziehungsweise technische Owner-Spalten) und den aktiven Organisationskontext strukturiert mitliefern.
