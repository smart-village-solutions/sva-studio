...
- **WHEN** der freigegebene Staging-Promote oder -Drill einen gültig signierten und per GitHub-OIDC authentisierten Staging-Auftrag mit eindeutiger Request-ID und unveränderlichem Image-Digest an `https://backup-studio-staging.smart-village.app/_ops/backup/v1/requests` sendet
...
- **WHEN** ein Production-Promote einen per GitHub-OIDC authentisierten Backup-Auftrag an `https://backup-studio.smart-village.app/_ops/backup/v1/requests` sendet
