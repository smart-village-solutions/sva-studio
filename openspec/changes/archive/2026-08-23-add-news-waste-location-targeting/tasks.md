## 1. Spezifikation und Modell

- [x] 1.1 OpenSpec-Deltas für Content, Waste und Mainserver ergänzen und strikt validieren
- [x] 1.2 Typisiertes Zielschlüssel- und verlustfreies Payload-Modell ergänzen

## 2. Editor

- [x] 2.1 Waste-Abholorte über die Host-API laden und in stabile Zielschlüssel auflösen
