...
- [x] 3.5 Root-Review und unabhängiges Datenschutz-/Runtime-Vertragsreview auf dem exakten PR-Head abschließen. Abschlussnachweis: PR #1010 wurde am 15. August 2026 nach Review gemergt.
- [x] 3.6 alle berechtigten Findings beheben und terminale PR-Gates ohne offene Threads abschließen. Die terminale Review-Auswertung weist keine offenen Threads, fehlgeschlagenen oder ausstehenden Checks aus.
