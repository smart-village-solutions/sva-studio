...
- Die bestehende Supabase-Datenbank wird in einem einmaligen Sonntagsfenster bei gestoppter Public-Waste-App sowie gesperrten und geleerten Studio-/Worker-Verbindungen zur Zieldatenbank per PostgreSQL-Dump und -Restore migriert; ein dauerhafter Anwendungs-Wartungsmodus wird nicht eingeführt.
- Die aus der Instanz-ID abgeleitete Ziel-Datenbank trennt tenantbezogene Owner-, Migrations-, administrative Runtime- und öffentliche Runtime-Rollen nach dem Least-Privilege-Prinzip.
- Cutover, Verifikation, verlustfreies Rollback-Gate vor neuen Zielschreibzugriffen und die anschließende 14-tägige Supabase-Aufbewahrung ohne produktive Runtime-Nutzung werden als wiederholbares Runbook dokumentiert.
...
- Breaking operational change: Nach dem Cutover ist die tenantgebundene PostgreSQL-Datenbank die einzige führende Waste-Fachdatenquelle; die Supabase-Quelle ist nur noch ein zeitlich begrenzter, von produktiven Waste-Runtimes isolierter Rollback-Stand.
