...
- [x] 0.5 A3 erst nach dokumentierter Event-/Branch-/SHA-/OCI-Parität blockierend aktivieren und anschließend 8.1 bis 8.5 abschließen; ein strukturell gültiges OpenSpec ersetzt keinen Workflow-, Staging- oder Live-Nachweis. Die aktuelle Kette aus Main-E2E `32901323487`, Build/Dev `32901324453`, Staging `32902510167` und Production `32902798040` bindet Main-HEAD `e027debabfda8ac0cc6d18c84aa786a9c51a0663` an denselben verifizierten App-Digest.
...
- [x] 7.4 Zweiphasige Coverage und Shard-Aggregatoren erst nach dokumentierter Parität blockierend aktivieren; alte Implementierung danach entfernen. Nach dem Merge veröffentlichte der exakte PR-HEAD `cde3a8b889940d849e067e7e0fded57d750d7aff` den internen Job `Coverage Complete` und den stabilen fail-closed Aggregator `Coverage`; beide waren erfolgreich.
- [x] 7.5 Mindestens 20 repräsentative PR-Läufe auswerten und Zielwerte von Median höchstens 3 Minuten sowie P90 höchstens 5 Minuten bis zum bestätigten relevanten Unit-/Coverage-Fehler prüfen; E2E-Kosten separat pro Main-Commit ausweisen. Die 20 grünen Endstände und separaten Main-E2E-Kosten sind ausgewertet; der einzige direkt zuordenbare rote Fall lag mit 172 Sekunden unter beiden Grenzen. Die für eine belastbare rote Verteilung zu kleine Stichprobe ist transparent dokumentiert und wird in `#1155` nicht blockierend fortgeführt.
...
- [x] 8.4 Workflow-, File-Placement-, Unit-, Type-, Coverage-, Main-E2E-Evidenz-, Promote-Preflight- und Aggregator-Contracts gezielt validieren und anschließend `pnpm test:pr` ohne E2E ausführen. Der committed PR-Scope bestand vollständige Coverage-, Sonar-, Coverage-Gate-, Complexity-, Lint-, Type-/Runtime-, Ops- und App-Build-Pfade. Der breite lokale Lauf stoppte ausschließlich an einem PR-fremden Compose-Timeout und einer primären Worktree-Containerkollision; der isolierte Test war grün. Die nachfolgende GitHub-Validierung des exakten PR-HEADs bestand `Unit`, `Types`, `Coverage`, `Complexity`, `PR Integration`, `App Build`, `File Placement` und die übrigen veröffentlichten Contracts erfolgreich; der kanonische Main-E2E-Run `32901323487` ist ebenfalls grün.
- [x] 8.5 OpenSpec strikt validieren und den Change erst nach dokumentierter Scope-/Ergebnisparität und Messzielprüfung abschließen. Ergebnisparität, fail-closed Scope-Vollständigkeit und Cutover sind in `docs/reports/pr-coverage-parity-cutover-2026-08-25.md`, die gemessenen grünen Median-/P90-Werte, der einzelne rote Messwert sowie getrennten Main-E2E-Kosten in `docs/reports/pr-quality-gate-latency-baseline-2026-08.md` dokumentiert. Die akzeptierten Nachweisverbesserungen `#1154` und `#1155` sind nicht blockierend; die abschließende strikte Validierung war unmittelbar vor der Archivierung grün.
