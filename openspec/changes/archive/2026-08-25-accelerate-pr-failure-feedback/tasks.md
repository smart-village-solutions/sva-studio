...
- [x] 8.5 OpenSpec strikt validieren und den Change erst nach dokumentierter Scope-/Ergebnisparität und Messzielprüfung abschließen. Scope-/Ergebnisparität und Cutover sind in `docs/reports/pr-coverage-parity-cutover-2026-08-25.md`, die gemessenen Median-/P90-Werte sowie getrennten Main-E2E-Kosten in `docs/reports/pr-quality-gate-latency-baseline-2026-08.md` dokumentiert; die abschließende strikte Validierung war unmittelbar vor der Archivierung grün.
