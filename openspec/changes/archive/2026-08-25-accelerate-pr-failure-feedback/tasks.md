...
- [x] 8.5 OpenSpec strikt validieren und den Change erst nach dokumentierter Scope-/Ergebnisparität und Messzielprüfung abschließen. Scope-/Ergebnisparität, Zielwerte und der Cutover sind in `docs/reports/pr-coverage-parity-cutover-2026-08-25.md` dokumentiert; die abschließende strikte Validierung erfolgt unmittelbar vor der Archivierung.
