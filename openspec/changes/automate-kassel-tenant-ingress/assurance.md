...
| `KAS-ACT-01`   | Ein Kasseler Create-Lauf ist nur nach erfolgreichem externem TLS-, Studio-Login-Redirect und maschinenprüfbarem modulabhängigem Readiness-Smoke erfolgreich; `active` ist ausschließlich der gemeinsame terminale Zustand von Instanz und Elternlauf.                               | Abbruchtests vor der Aktivierung sowie öffentliche Studio-Smokes                        |
