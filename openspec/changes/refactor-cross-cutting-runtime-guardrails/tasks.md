...
> Standabgleich 18.06.2026: Der inhaltliche Review des Alt-PRs `#441` bestätigt, dass keine Reanimation des Branches nötig ist. Die noch relevanten Restpunkte sind bereits durch die offenen Tasks dieses Changes abgedeckt, insbesondere `1.1` bis `1.4`, `2.1` bis `2.3`, `3.1` bis `3.2` und `4.3`.
