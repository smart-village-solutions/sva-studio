...
### Requirement: Tenant-Realm verwendet system_admin als geschützte Defaultrolle
Das System SHALL im Tenant-Realm `system_admin` als geschützte, defaultfähige Vollzugriffsrolle für die initiale Instanzadministration beibehalten.
