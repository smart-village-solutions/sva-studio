...
- [x] 1.1 Boundary-Tests ergänzen, die `@sva/data` als Shim auf `@sva/data-repositories` absichern
- [x] 1.2 Lokale Instanz-Registry-Implementierung in `@sva/data` durch Re-Exports der führenden Persistence-Schicht ersetzen
- [x] 1.3 Root-API von `@sva/instance-registry` von internen Service- und Provisioning-Helfern bereinigen
