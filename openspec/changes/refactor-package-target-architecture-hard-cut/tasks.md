...
- [ ] 5.1 Login, Logout, OIDC, Cookies, Session und Middleware in `@sva/auth-runtime` bündeln
  - Fortschritt: Auth-/Session-Typen und Scope-Helfer liegen in `@sva/auth-runtime`; OIDC-, Login-, Callback-, Session-, Cookie- und Middleware-Code nutzt diese Runtime-Verträge lokal.
