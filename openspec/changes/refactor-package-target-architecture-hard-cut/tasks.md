...
- [ ] 5.4 Instanzmodell, Host-Klassifikation, Registry und Provisioning in `@sva/instance-registry` verschieben
  ...
  - Offen: CSRF-Adapter, concrete Keycloak-Admin-Client-Factory und konkrete Secret-/Provisioner-Adapter liegen noch unter `packages/auth/src/iam-instance-registry`.
