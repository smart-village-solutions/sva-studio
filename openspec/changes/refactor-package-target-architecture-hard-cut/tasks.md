...
- [ ] 5.1 Login, Logout, OIDC, Cookies, Session und Middleware in `@sva/auth-runtime` bündeln
  ...
  - Offen: `@sva/auth-runtime` importiert noch serverseitige Implementierung aus `@sva/auth/server` für Audit-Events, Legal-Text-Compliance, JIT, Mainserver-Credentials und Kompatibilitäts-Routen.
