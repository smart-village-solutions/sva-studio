...
- Decision: Standard-Seeds sind normativ non-destructive für geschützte Identitätsfelder.
  - Geschützte Felder umfassen mindestens `parent_domain`, `primary_hostname`, `auth_realm`, `auth_client_id` und `tenant_admin_client_id`.
...
5. Betriebs- und Architektur-Dokumentation anpassen.
