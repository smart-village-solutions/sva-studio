...
#### Scenario: Neu hochgeladenes Medium wird erst nach Abschluss zugeordnet

- **WENN** ein Benutzer in einem Content-Editor ein neues Medium über den hostseitigen Overlay-Flow hochlädt
- **DANN** wird das Medium dem offenen Content-Datensatz nicht sofort zugeordnet
- **UND** die Zuordnung erfolgt erst nach erfolgreichem Review-Schritt und expliziter Abschlussaktion wie `Medium übernehmen`
- **UND** ein abgebrochener Overlay-Flow hinterlässt keinen neuen Medieneintrag im Content-Formular
