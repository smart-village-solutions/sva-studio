...
## What Changes
- erweitert die Instanzverwaltung um editierbare Realm-Grundeinstellungen pro Instanz
- ergänzt einen expliziten Keycloak-Status- und Reconcile-Pfad für Tenant-Realm, `sva-studio`-Client, `instanceId`-Mapper und initialen Tenant-Admin
...
- erweitert die Root-Host-UI `/admin/instances` zu einer operativen Control Plane für Registry- und Keycloak-Basiszustand
