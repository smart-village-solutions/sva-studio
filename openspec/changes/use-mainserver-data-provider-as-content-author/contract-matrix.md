...
- Reale Read-Contract-Tests entscheiden, ob eine einzelne Credential-Sicht diese Menge vollständig liefert oder getrennte persönliche und organisatorische Projection-Scopes erforderlich sind. Nur im zweiten Fall werden sie isoliert synchronisiert und vor globaler Sortierung und Pagination dedupliziert vereinigt; jeder Teilausfall wird unabhängig von vorhandenen alten Snapshots sichtbar als unvollständiges Ergebnis ausgewiesen und erweitert keine Mutationsberechtigung.
