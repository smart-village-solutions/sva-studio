...
export type ApiErrorCode = 'unauthorized' | 'invalid_service_token' | 'missing_platform_role' | 'missing_action_scope' | 'identity_provider_unavailable' | 'forbidden' | 'not_found' | 'invalid_request' | 'invalid_instance_id' | 'invalid_organization_id' | 'organization_inactive' | 'rate_limited' | 'csrf_validation_failed' | 'idempotency_key_required' | 'idempotency_key_reuse' | 'idempotency_in_progress' | 'keycloak_unavailable' | 'tenant_auth_client_secret_missing' | 'tenant_admin_client_not_configured' | 'tenant_admin_client_secret_missing' | 'encryption_not_configured' | 'database_unavailable' | 'mainserver_configuration_incomplete' | 'mainserver_credentials_missing' | 'mainserver_credentials_unavailable' | 'mainserver_credentials_invalid' | 'mainserver_user_conflict' | 'mainserver_provisioning_failed' | 'last_admin_protection' | 'self_protection' | 'feature_disabled' | 'conflict' | 'legal_acceptance_required' | 'reauth_required' | 'confirmation_required' | 'invalid_confirmation' | 'internal_unclassified' | 'internal_error';
