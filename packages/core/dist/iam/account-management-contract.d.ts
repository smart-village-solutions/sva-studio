...
export type ApiErrorCode = 'unauthorized' | 'invalid_service_token' | 'missing_platform_role' | 'missing_action_scope' | 'identity_provider_unavailable' | 'forbidden' | 'not_found' | 'invalid_request' | 'invalid_instance_id' | 'invalid_organization_id' | 'organization_inactive' | 'rate_limited' | 'csrf_validation_failed' | 'idempotency_key_required' | 'idempotency_key_reuse' | 'idempotency_in_progress' | 'plugin_activation_required_cannot_disable' | 'plugin_activation_state_conflict' | 'unknown_module_contract' | 'plugin_tenant_lifecycle_not_declared' | 'plugin_tenant_lifecycle_inactive' | 'plugin_tenant_lifecycle_operation_not_declared' | 'plugin_tenant_lifecycle_handler_missing' | 'plugin_tenant_lifecycle_cancellation_mismatch' | 'plugin_tenant_lifecycle_claim_conflict' | 'plugin_tenant_lifecycle_invalid_transition' | 'plugin_tenant_lifecycle_request_conflict' | 'plugin_tenant_lifecycle_claim_failed' | 'plugin_tenant_lifecycle_job_creation_failed' | 'plugin_tenant_lifecycle_enqueue_failed' | 'plugin_tenant_lifecycle_start_failed' | 'plugin_tenant_access_blocked' | 'invalid_source_year' | 'replacement_date_invalid' | 'batch_limit_exceeded' | 'preview_stale' | 'target_identity_conflict' | 'target_conflict_unacknowledged' | 'active_job_exists' | 'keycloak_unavailable' | 'keycloak_request_failed' | 'keycloak_role_write_rejected' | 'tenant_auth_client_secret_missing' | 'tenant_admin_client_not_configured' | 'tenant_admin_client_secret_missing' | 'encryption_not_configured' | 'database_unavailable' | 'mainserver_configuration_incomplete' | 'mainserver_credentials_missing' | 'mainserver_credentials_partial' | 'mainserver_credentials_stale' | 'mainserver_credentials_unavailable' | 'mainserver_credentials_invalid' | 'mainserver_user_conflict' | 'mainserver_provisioning_failed' | 'keycloak_role_protected' | 'keycloak_role_assignment_not_direct' | 'keycloak_role_assignment_reconciliation_required' | 'last_admin_protection' | 'self_protection' | 'feature_disabled' | 'conflict' | 'legal_acceptance_required' | 'reauth_required' | 'confirmation_required' | 'invalid_confirmation' | 'internal_unclassified' | 'internal_error';
...
export type IamInstanceProvisioningCapabilityKey = 'worker' | 'queue' | 'callback' | 'provisioner' | 'ingress' | 'plugin';
...
export type IamInstanceProvisioningReadiness = {
    ...
    readonly nextAction: Readonly<{
        action: 'instance.readiness.refresh' | 'instance.keycloak.execute' | 'instance.provisioning.retry' | 'instance.tenant-iam.probe' | 'instance.tenant-iam.reconcile' | 'instance.status.activate';
