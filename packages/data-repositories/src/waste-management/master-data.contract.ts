...
export const wasteMasterDataRepositoryContract = {
  ...
  getWasteFractionById:
    defineRepositoryMethod<(id: string) => Promise<WasteFractionRecord | null>>(),
  upsertWasteFraction:
    defineRepositoryMethod<
  ...
  listWasteRegions:
    defineRepositoryMethod<
      (filter?: WasteRegionListFilter) => Promise<readonly WasteRegionRecord[]>
    >(),
  ...
  upsertWasteRegion:
    ...
    >(),
  listWasteCities:
    defineRepositoryMethod<(filter?: WasteCityListFilter) => Promise<readonly WasteCityRecord[]>>(),
  ...
  getWasteHouseNumberById:
    defineRepositoryMethod<(id: string) => Promise<WasteHouseNumberRecord | null>>(),
  ...
  getWastePdfStaticSettings:
    defineRepositoryMethod<() => Promise<WastePdfStaticSettingsRecord | null>>(),
  upsertWastePdfStaticSettings:
    defineRepositoryMethod<(input: WastePdfStaticSettingsWriteInput) => Promise<void>>(),
  ...
  listWasteCustomRecurrencePresets:
    defineRepositoryMethod<() => Promise<readonly WasteCustomRecurrencePresetRecord[]>>(),
  getWasteCustomRecurrencePresetById:
    defineRepositoryMethod<(id: string) => Promise<WasteCustomRecurrencePresetRecord | null>>(),
  ...
  listWasteTours:
    defineRepositoryMethod<(filter?: WasteTourListFilter) => Promise<readonly WasteTourRecord[]>>(),
  getWasteTourById: defineRepositoryMethod<(id: string) => Promise<WasteTourRecord | null>>(),
  lockWasteToursByIds:
    defineRepositoryMethod<
      (ids: readonly string[]) => Promise<readonly WasteTourValidityRecord[]>
    >(),
  ...
  listWasteLocationTourLinksByTourId:
    defineRepositoryMethod<(tourId: string) => Promise<readonly WasteLocationTourLinkRecord[]>>(),
  getWasteLocationTourLinkById:
    defineRepositoryMethod<(id: string) => Promise<WasteLocationTourLinkRecord | null>>(),
  ...
  getWasteLocationTourPickupDateById:
    defineRepositoryMethod<(id: string) => Promise<WasteLocationTourPickupDateRecord | null>>(),
  ...
  listWasteTourAssignments:
    defineRepositoryMethod<
      (filter?: WasteTourAssignmentListFilter) => Promise<readonly WasteTourAssignmentRecord[]>
    >(),
  getWasteTourAssignmentById:
    defineRepositoryMethod<(id: string) => Promise<WasteTourAssignmentRecord | null>>(),
  upsertWasteTourAssignment:
    defineRepositoryMethod<
      (input: Omit<WasteTourAssignmentRecord, 'createdAt' | 'updatedAt'>) => Promise<void>
    >(),
  deleteWasteTourAssignment: defineRepositoryMethod<(id: string) => Promise<void>>(),
  ...
  getWasteGlobalDateShiftById:
    defineRepositoryMethod<(id: string) => Promise<WasteGlobalDateShiftRecord | null>>(),
