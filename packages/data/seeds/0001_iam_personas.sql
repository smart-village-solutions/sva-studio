...
VALUES
  ('40111111-1111-1111-1111-111111111111', 'de-musterhausen', 'iam.user.read', 'iam.user.read', 'iam', NULL, '{}'::jsonb, 'Read account data'),
  ('40111111-1111-1111-1111-111111111112', 'de-musterhausen', 'iam.user.write', 'iam.user.write', 'iam', NULL, '{}'::jsonb, 'Modify account data'),
  ('40111111-1111-1111-1111-111111111113', 'de-musterhausen', 'iam.role.read', 'iam.role.read', 'iam', NULL, '{}'::jsonb, 'Read role assignments'),
  ('40111111-1111-1111-1111-111111111114', 'de-musterhausen', 'iam.role.write', 'iam.role.write', 'iam', NULL, '{}'::jsonb, 'Modify role assignments'),
  ('40111111-1111-1111-1111-111111111115', 'de-musterhausen', 'iam.org.read', 'iam.org.read', 'iam', NULL, '{}'::jsonb, 'Read organization data'),
  ('40111111-1111-1111-1111-111111111116', 'de-musterhausen', 'iam.org.write', 'iam.org.write', 'iam', NULL, '{}'::jsonb, 'Modify organization data'),
  ('40111111-1111-1111-1111-111111111117', 'de-musterhausen', 'content.read', 'content.read', 'content', NULL, '{}'::jsonb, 'Read content'),
  ('40111111-1111-1111-1111-111111111118', 'de-musterhausen', 'content.create', 'content.create', 'content', NULL, '{}'::jsonb, 'Create content'),
  ('40111111-1111-1111-1111-111111111119', 'de-musterhausen', 'content.updateMetadata', 'content.updateMetadata', 'content', NULL, '{}'::jsonb, 'Update content metadata'),
  ('40111111-1111-1111-1111-111111111120', 'de-musterhausen', 'content.publish', 'content.publish', 'content', NULL, '{}'::jsonb, 'Publish content'),
  ('40111111-1111-1111-1111-111111111121', 'de-musterhausen', 'content.manageRevisions', 'content.manageRevisions', 'content', NULL, '{}'::jsonb, 'Manage content revisions'),
  ('40111111-1111-1111-1111-111111111122', 'de-musterhausen', 'integration.manage', 'integration.manage', 'integration', NULL, '{}'::jsonb, 'Manage integrations'),
  ('40111111-1111-1111-1111-111111111123', 'de-musterhausen', 'feature.toggle', 'feature.toggle', 'feature', NULL, '{}'::jsonb, 'Toggle feature flags'),
  ('40111111-1111-1111-1111-111111111149', 'de-musterhausen', 'app.read', 'app.read', 'app', NULL, '{}'::jsonb, 'Show the app link in the sidebar'),
  ('40111111-1111-1111-1111-111111111150', 'de-musterhausen', 'cockpit.read', 'cockpit.read', 'cockpit', NULL, '{}'::jsonb, 'Show the cockpit link in the sidebar'),
  ('40111111-1111-1111-1111-111111111169', 'de-musterhausen', 'modules.read', 'modules.read', 'modules', NULL, '{}'::jsonb, 'Show the modules overview in the Studio'),
  ('40111111-1111-1111-1111-111111111124', 'de-musterhausen', 'instance.registry.manage', 'instance.registry.manage', 'instance', NULL, '{}'::jsonb, 'Manage instance registry and provisioning'),
  ('40111111-1111-1111-1111-111111111125', 'de-musterhausen', 'content.updatePayload', 'content.updatePayload', 'content', NULL, '{}'::jsonb, 'Update content payload'),
  ('40111111-1111-1111-1111-111111111126', 'de-musterhausen', 'content.changeStatus', 'content.changeStatus', 'content', NULL, '{}'::jsonb, 'Change content status'),
  ('40111111-1111-1111-1111-111111111127', 'de-musterhausen', 'content.archive', 'content.archive', 'content', NULL, '{}'::jsonb, 'Archive content'),
  ...
  ('40111111-1111-1111-1111-111111111146', 'de-musterhausen', 'media.reference.manage', 'media.reference.manage', 'media', NULL, '{}'::jsonb, 'Manage media references'),
  ('40111111-1111-1111-1111-111111111147', 'de-musterhausen', 'media.delete', 'media.delete', 'media', NULL, '{}'::jsonb, 'Delete media'),
  ('40111111-1111-1111-1111-111111111148', 'de-musterhausen', 'media.deliver.protected', 'media.deliver.protected', 'media', NULL, '{}'::jsonb, 'Deliver protected media'),
  ('40111111-1111-1111-1111-111111111151', 'de-musterhausen', 'iam.legalText.read', 'iam.legalText.read', 'iam', NULL, '{}'::jsonb, 'Read legal text administration data'),
  ('40111111-1111-1111-1111-111111111152', 'de-musterhausen', 'iam.legalText.write', 'iam.legalText.write', 'iam', NULL, '{}'::jsonb, 'Modify legal text administration data'),
  ('40111111-1111-1111-1111-111111111153', 'de-musterhausen', 'iam.governance.read', 'iam.governance.read', 'iam', NULL, '{}'::jsonb, 'Read governance workflows and audit trails'),
  ('40111111-1111-1111-1111-111111111154', 'de-musterhausen', 'iam.governance.write', 'iam.governance.write', 'iam', NULL, '{}'::jsonb, 'Execute governance workflows and decisions'),
  ('40111111-1111-1111-1111-111111111155', 'de-musterhausen', 'iam.governance.export', 'iam.governance.export', 'iam', NULL, '{}'::jsonb, 'Export governance and legal consent evidence'),
  ('40111111-1111-1111-1111-111111111156', 'de-musterhausen', 'iam.dsr.read', 'iam.dsr.read', 'iam', NULL, '{}'::jsonb, 'Read tenant data-subject-rights cases'),
  ('40111111-1111-1111-1111-111111111157', 'de-musterhausen', 'iam.dsr.write', 'iam.dsr.write', 'iam', NULL, '{}'::jsonb, 'Process tenant data-subject-rights cases'),
  ('40111111-1111-1111-1111-111111111158', 'de-musterhausen', 'iam.dsr.export', 'iam.dsr.export', 'iam', NULL, '{}'::jsonb, 'Export tenant data-subject-rights payloads'),
  ('40111111-1111-1111-1111-111111111159', 'de-musterhausen', 'iam.deletionRules.read', 'iam.deletionRules.read', 'iam', NULL, '{}'::jsonb, 'Read tenant deletion rules'),
  ('40111111-1111-1111-1111-111111111160', 'de-musterhausen', 'iam.deletionRules.write', 'iam.deletionRules.write', 'iam', NULL, '{}'::jsonb, 'Modify tenant deletion rules'),
  ('40111111-1111-1111-1111-111111111161', 'de-musterhausen', 'iam.monitoring.read', 'iam.monitoring.read', 'iam', NULL, '{}'::jsonb, 'Read IAM monitoring and plugin operation status'),
  ('40111111-1111-1111-1111-111111111162', 'de-musterhausen', 'iam.monitoring.write', 'iam.monitoring.write', 'iam', NULL, '{}'::jsonb, 'Run IAM monitoring and plugin operations'),
  ('40111111-1111-1111-1111-111111111163', 'de-musterhausen', 'experimental.read', 'experimental.read', 'experimental', NULL, '{}'::jsonb, 'Enable experimental shell features and placeholders'),
  ('40111111-1111-1111-1111-111111111168', 'de-musterhausen', 'iam.accounts.delete', 'iam.accounts.delete', 'iam', NULL, '{}'::jsonb, 'Delete tenant accounts physically'),
  ('40111111-1111-1111-1111-111111111131', 'de-musterhausen', 'news.read', 'news.read', 'news', NULL, '{}'::jsonb, 'Read news plugin content'),
  ...
  ('40111111-1111-1111-1111-111111111138', 'de-musterhausen', 'events.delete', 'events.delete', 'events', NULL, '{}'::jsonb, 'Delete events plugin content'),
  ('40111111-1111-1111-1111-111111111139', 'de-musterhausen', 'poi.read', 'poi.read', 'poi', NULL, '{}'::jsonb, 'Read POI plugin content'),
  ('40111111-1111-1111-1111-111111111140', 'de-musterhausen', 'poi.create', 'poi.create', 'poi', NULL, '{}'::jsonb, 'Create POI plugin content'),
  ('40111111-1111-1111-1111-111111111141', 'de-musterhausen', 'poi.update', 'poi.update', 'poi', NULL, '{}'::jsonb, 'Update POI plugin content'),
  ('40111111-1111-1111-1111-111111111142', 'de-musterhausen', 'poi.delete', 'poi.delete', 'poi', NULL, '{}'::jsonb, 'Delete POI plugin content'),
  ('40111111-1111-1111-1111-111111111164', 'de-musterhausen', 'categories.read', 'categories.read', 'categories', NULL, '{}'::jsonb, 'Read categories plugin content'),
  ('40111111-1111-1111-1111-111111111165', 'de-musterhausen', 'categories.create', 'categories.create', 'categories', NULL, '{}'::jsonb, 'Create categories plugin content'),
  ('40111111-1111-1111-1111-111111111166', 'de-musterhausen', 'categories.update', 'categories.update', 'categories', NULL, '{}'::jsonb, 'Update categories plugin content'),
  ('40111111-1111-1111-1111-111111111167', 'de-musterhausen', 'categories.delete', 'categories.delete', 'categories', NULL, '{}'::jsonb, 'Delete categories plugin content')
...
FROM (
  VALUES
    ...
    ('system_admin', 'iam.accounts.delete'),
