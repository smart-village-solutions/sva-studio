...
VALUES
  ...
  ('64111111-1111-1111-1111-111111111169', 'bb-guben', 'modules.read', 'modules.read', 'modules', NULL, '{}'::jsonb, 'Show the modules overview in the Studio'),
  ...
  ('64111111-1111-1111-1111-111111111171', 'bb-guben', 'content.transferOwnership', 'content.transferOwnership', 'content', NULL, '{}'::jsonb, 'Transfer content ownership'),
  ...
  ('64111111-1111-1111-1111-111111111168', 'bb-guben', 'iam.accounts.delete', 'iam.accounts.delete', 'iam', NULL, '{}'::jsonb, 'Delete tenant accounts physically'),
