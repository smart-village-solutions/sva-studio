...
const categoriesTranslationsDe = createCategoriesLocaleTranslations({
  ...
  messages: {
    ...
    createForbidden: 'Zum Anlegen einer Kategorie fehlt die Berechtigung categories.create.',
    updateForbidden: 'Zum Bearbeiten einer Kategorie fehlt die Berechtigung categories.update.',
    deleteForbidden: 'Zum Löschen einer Kategorie fehlt die Berechtigung categories.delete.',
...
const categoriesTranslationsEn = createCategoriesLocaleTranslations({
  ...
  messages: {
    ...
    createForbidden: 'The categories.create permission is required to create a category.',
    updateForbidden: 'The categories.update permission is required to update a category.',
    deleteForbidden: 'The categories.delete permission is required to delete a category.',
    loadErrorManagementAccess:
