  ...
  de: {
    'cockpit-cards': {
      ...
      validation: {
        ...
        images: 'Alle Bilder müssen gültige, dauerhaft speicherbare HTTP- oder HTTPS-Bilder sein.',
  ...
  en: {
    'cockpit-cards': {
      ...
      validation: {
        ...
        images: 'All images must be valid HTTP or HTTPS images suitable for permanent storage.',
