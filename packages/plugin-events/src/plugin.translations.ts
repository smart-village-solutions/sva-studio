...
const eventsTranslationsDe = createEventsLocaleTranslations({
  ...
  actions: {
    ...
    deleteConfirm: 'Die Veranstaltung „{{title}}“ wird endgültig gelöscht.',
...
const eventsTranslationsEn = createEventsLocaleTranslations({
  ...
  actions: {
    ...
    deleteConfirm: 'The event “{{title}}” will be permanently deleted.',
    addDate: 'Add date',
  ...
  messages: {
    mediaReferencePartialFailure:
      'The content was saved, but its media references were not. You can retry the references.',
