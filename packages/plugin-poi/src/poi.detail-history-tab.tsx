...
export function PoiDetailHistoryTab({ contentId, pt }: Readonly<{ contentId?: string; pt: Translate }>) {
  return (
    <StudioContentHistory
      contentId={contentId}
      loadHistory={(id) => fetchIamContentHistory(id, { contentType: 'poi.point-of-interest' })}
      labels={{
