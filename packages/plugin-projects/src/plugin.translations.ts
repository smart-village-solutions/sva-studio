...
const de = {
  projects: {
    ...
    history: {
      ...
      sourceNotice: 'Die Historie zeigt erfolgreiche Änderungen aus dem Studio. Änderungen außerhalb des Studios können fehlen.',
      emptySummary: 'Keine weiteren Angaben',
      columns: { time: 'Zeitpunkt', action: 'Aktion', actor: 'Bearbeitet von', summary: 'Änderung' },
...
const en = {
  projects: {
    ...
    history: {
      ...
      sourceNotice: 'History shows successful changes made in Studio. Changes made outside Studio may be missing.',
