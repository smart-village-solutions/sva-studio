export const pluginSurveysStructureTranslations = {
  ...
  actions: {
    ...
    moveOptionUp: 'Antwort {{index}} nach oben',
    moveOptionDown: 'Antwort {{index}} nach unten',
    deleteOption: 'Antwort {{index}} löschen',
  ...
  cards: {
    ...
    content: {
      ...
      questions: {
        title: 'Fragen',
        description: 'Fragen und Antworten der Umfrage.',
      },
    },
    moderation: {
