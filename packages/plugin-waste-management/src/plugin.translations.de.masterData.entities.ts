export const wasteManagementPluginTranslationsDEMasterDataEntities = {
  regions: {
    title: 'Regionen',
  ...
  cities: {
    ...
    meta: { cityId: 'Ort-ID: {{value}}', regionId: 'Region-ID: {{value}}' },
  },
  streets: {
    title: 'Straßen',
    ...
    fields: { name: 'Name', cityId: 'Ort', cityUnset: 'Ort auswählen' },
    dialog: {
    ...
    meta: { streetId: 'Straßen-ID: {{value}}', cityId: 'Ort-ID: {{value}}' },
  },
  houseNumbers: {
    title: 'Hausnummern',
    ...
    fields: { number: 'Hausnummer', streetId: 'Straße', streetUnset: 'Straße auswählen' },
    dialog: {
    ...
    meta: { houseNumberId: 'Hausnummer-ID: {{value}}', streetId: 'Straßen-ID: {{value}}' },
  },
  collectionLocations: {
    title: 'Abholorte',
    description:
