export const wasteManagementPluginTranslationsDEMasterDataFractions = {
  ...
  description: 'Pflegen Sie die sichtbaren Fraktionen als ersten Bearbeitungsbereich des Moduls.',
  color: 'Farbe: {{value}}',
  containerSize: 'Behälter: {{value}}',
  table: {
    ariaLabel: 'Tabelle der Abfallfraktionen',
    caption: 'Tabelle der Abfallfraktionen mit Status, Metadaten und Aktionen.',
    name: 'Fraktion',
  ...
  messages: {
    createSuccess: 'Die Abfall-Fraktion wurde angelegt.',
    updateSuccess: 'Die Abfall-Fraktion wurde aktualisiert.',
    deleteSuccess: 'Die Abfall-Fraktion wurde gelöscht.',
