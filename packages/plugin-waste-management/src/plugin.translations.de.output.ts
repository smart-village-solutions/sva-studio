  ...
  output: {
    ...
    emailReminder: {
      ...
      sections: {
        ...
        doi: 'Double Opt In',
        reminder: 'Erinnerung-Kommunikation',
        unsubscribe: 'Abmeldeseite',
        guardrails: 'Technische Leitplanken',
      },
      sectionHints: {
        transport:
          'Der Abfall-Dienst referenziert hier nur einen zentralen Mail-Transport aus dem Bereich Schnittstellen.',
      },
      fields: {
        ...
        reminderSubjectTemplate: 'Erinnerung-Betreff',
        reminderIntroTemplate: 'Erinnerungs-Einleitung',
        ...
        unsubscribeErrorHeadline: 'Überschrift bei Abmeldefehler',
      ...
      meta: {
        ...
        runtimeHint:
          'Die eigentliche Zustellung erfolgt über die zentrale Mail-Transport-Schnittstelle; Abfall speichert hier nur die fachliche Ausgabekonfiguration.',
      },
    },
  },
} as const;
