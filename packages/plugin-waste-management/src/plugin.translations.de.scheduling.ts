...
export const wasteManagementPluginTranslationsDEScheduling = createWasteManagementSchedulingTranslations({
  ...
  table: {
    ...
    description: 'Globale und tourbezogene Ausweichtermine in einer gemeinsamen Tabelle.',
    ariaLabel: 'Tabelle der Waste-Ausweichtermine',
    caption: 'Tabelle der globalen und tourbezogenen Waste-Ausweichtermine mit Kontext und Aktionen.',
    scope: 'Typ',
    context: 'Bezug',
    scopeGlobal: 'Global',
    scopeTour: 'Tour',
