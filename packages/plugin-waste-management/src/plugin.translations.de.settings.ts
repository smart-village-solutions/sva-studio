...
export const wasteManagementPluginTranslationsDESettings =
  createWasteManagementSettingsTranslations({
    ...
    messages: {
      ...
      saveSuccessWithHolidaySync:
        'Die Abfall-Einstellungen wurden gespeichert. Feiertagssync: {{status}}.',
      ...
      customRecurrenceDeleteDescription:
        'Der Abstand {{name}} wird entfernt. Falls zugeordnete Touren existieren, verwendet der Server den gewählten Fallback.',
      customRecurrenceFallbackHint:
        'Optional: Wählen Sie direkt einen Fallback, falls dieser Abstand bereits Touren zugeordnet ist.',
      customRecurrenceFallbackPlaceholder: 'Keinen Fallback vorauswählen',
      noInterfacesAvailable:
        'Es wurden noch keine externen Schnittstellen für diese Instanz hinterlegt.',
