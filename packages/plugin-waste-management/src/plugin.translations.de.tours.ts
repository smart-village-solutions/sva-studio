...
export const wasteManagementPluginTranslationsDETours = createWasteManagementToursTranslations({
  ...
  selection: {
    selectFiltered: 'Alle {{value}} gefilterten Touren auswählen',
  ...
  bulkStatusDialog: {
    ...
    description: 'Legen Sie den Zielstatus für {{value}} ausgewählte Touren fest.',
    ...
    apply: 'Status ändern',
    cancel: 'Abbrechen',
    error: 'Der Status konnte nicht geändert werden. Die Auswahl bleibt erhalten.',
