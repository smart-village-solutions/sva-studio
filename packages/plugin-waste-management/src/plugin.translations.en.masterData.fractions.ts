export const wasteManagementPluginTranslationsENMasterDataFractions = {
  ...
  fields: {
    ...
    reminderPushSlot1MaxLeadDays: 'Push reminder 1: maximum lead time',
    reminderPushSlot1DefaultLeadDays: 'Push reminder 1: default lead time',
    reminderPushSlot2MaxLeadDays: 'Push reminder 2: maximum lead time',
    reminderPushSlot2DefaultLeadDays: 'Push reminder 2: default lead time',
    reminderEmailSlot1MaxLeadDays: 'Email reminder 1: maximum lead time',
    reminderEmailSlot1DefaultLeadDays: 'Email reminder 1: default lead time',
    reminderEmailSlot2MaxLeadDays: 'Email reminder 2: maximum lead time',
    reminderEmailSlot2DefaultLeadDays: 'Email reminder 2: default lead time',
    reminderCalendarSlot1MaxLeadDays: 'Calendar reminder 1: maximum lead time',
    reminderCalendarSlot1DefaultLeadDays: 'Calendar reminder 1: default lead time',
    reminderCalendarSlot2MaxLeadDays: 'Calendar reminder 2: maximum lead time',
    reminderCalendarSlot2DefaultLeadDays: 'Calendar reminder 2: default lead time',
  },
  filters: {
    open: 'Filter',
    reset: 'Reset filters',
