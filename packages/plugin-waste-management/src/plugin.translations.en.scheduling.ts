...
export const wasteManagementPluginTranslationsENScheduling =
  createWasteManagementSchedulingTranslations({
    ...
    assignments: {
      ...
      description:
        'Explicit tour assignments with a date, multiple pickup locations, and an optional note.',
      empty: 'No explicit tour assignments have been stored yet.',
      actions: {
      ...
      dialog: {
        ...
        createDescription: 'Select the tour, date, and all pickup locations.',
      ...
      fields: {
        ...
        locationsHint:
          'Parent locations can be selected directly and apply to their child pickup locations.',
        note: 'Note (optional)',
      },
      table: {
        ariaLabel: 'Table of explicit tour assignments',
        caption: 'Tour assignments with date, tour, pickup locations, note, and actions.',
        pickupDate: 'Date',
        tour: 'Tour',
        locations: 'Pickup locations',
        note: 'Note',
      ...
      validation: {
        required: 'Tour, date, and at least one pickup location are required.',
      },
      messages: {
        createSuccess: 'The tour assignment was created.',
        updateSuccess: 'The tour assignment was updated.',
        saveError: 'The tour assignment could not be saved.',
        saveForbidden: 'Missing permission to save tour assignments.',
    ...
    table: {
      ...
      caption:
        'Table of holiday rules, global shifts, and tour-related waste scheduling shifts with context and actions.',
      selection: 'Selection',
      scope: 'Type',
      context: 'Context',
