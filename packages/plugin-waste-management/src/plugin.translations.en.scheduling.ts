...
export const wasteManagementPluginTranslationsENScheduling = createWasteManagementSchedulingTranslations({
  ...
  table: {
    ...
    description: 'Global and tour-related shifts in one shared table.',
    ariaLabel: 'Table of waste scheduling shifts',
    caption: 'Table of global and tour-related waste scheduling shifts with context and actions.',
    scope: 'Type',
    context: 'Context',
    scopeGlobal: 'Global',
    scopeTour: 'Tour',
