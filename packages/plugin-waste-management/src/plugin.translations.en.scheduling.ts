...
export const wasteManagementPluginTranslationsENScheduling = createWasteManagementSchedulingTranslations({
  ...
  schadstoffmobil: {
    title: 'Hazardous waste mobile stops',
    description: 'Explicit hazardous waste mobile stops with date, pickup location, and free-text note.',
    empty: 'No hazardous waste mobile stops have been stored yet.',
    actions: {
      openCreate: 'Create stop',
      edit: 'Edit',
      delete: 'Delete',
      cancel: 'Cancel',
      create: 'Save stop',
      save: 'Save changes',
      confirmDelete: 'Delete stop',
    },
    dialog: {
      createTitle: 'Create hazardous waste mobile stop',
      createDescription: 'Provide the date, pickup location, and note for a specific stop.',
      editTitle: 'Edit hazardous waste mobile stop',
      editDescription: 'Adjust the date, pickup location, or note for the stop.',
      deleteTitle: 'Delete hazardous waste mobile stop',
      deleteDescription: 'Do you really want to delete this hazardous waste mobile stop?',
    },
    fields: {
      pickupDate: 'Date',
      location: 'Pickup location',
      locationUnset: 'Select pickup location',
      note: 'Note',
    },
    table: {
      ariaLabel: 'Table of hazardous waste mobile stops',
      caption: 'Table of hazardous waste mobile stops with date, pickup location, note, and actions.',
      pickupDate: 'Date',
      location: 'Pickup location',
      note: 'Note',
      actions: 'Actions',
    ...
    validation: {
      noteRequired: 'A note is required for hazardous waste mobile stops.',
    },
    messages: {
      createSuccess: 'The hazardous waste mobile stop was created.',
      updateSuccess: 'The hazardous waste mobile stop was updated.',
      saveError: 'The hazardous waste mobile stop could not be saved.',
      saveForbidden: 'Missing permission to save hazardous waste mobile stops.',
      deleteSuccess: 'The hazardous waste mobile stop was deleted.',
      deleteError: 'The hazardous waste mobile stop could not be deleted.',
      deleteForbidden: 'Missing permission to delete hazardous waste mobile stops.',
    },
  },
  actions: {
