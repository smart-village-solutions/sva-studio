  ...
  createWasteManagementSettingsTranslations({
    ...
    messages: {
      ...
      customRecurrenceDeleteDescription:
        'The interval {{name}} will be removed. If tours are still assigned, the server uses the selected fallback.',
      customRecurrenceFallbackHint:
        'Optional: preselect a fallback when this interval is already assigned to tours.',
