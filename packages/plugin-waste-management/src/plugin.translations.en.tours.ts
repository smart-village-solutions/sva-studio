...
export const wasteManagementPluginTranslationsENTours = createWasteManagementToursTranslations({
  ...
  selection: {
    selectFilteredOne: 'Select one filtered tour',
    selectFilteredOther: 'Select all {{value}} filtered tours',
    deselectFiltered: 'Deselect filtered tours',
    selectedCountOne: 'One tour selected',
    selectedCountOther: '{{value}} tours selected',
  ...
  bulkStatusDialog: {
    ...
    refreshError:
      'The status was changed, but the list could not be refreshed. The dialog remains open so you can retry.',
  ...
  annualTransfer: {
    open: 'Transfer tour set to following year',
    title: 'Transfer annual schedule to the following year',
    description: 'Choose the source year. The direct following year is fixed automatically.',
    sourceYear: 'Source year',
    targetYear: 'Fixed following year: {{year}}',
    ...
    creating: 'Creating tour set…',
    transferable: 'Will be transferred',
    alreadyEffective: 'Already effective in the following year',
