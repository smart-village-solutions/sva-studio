...
export const WasteToursListView = ({
  ...
  return (
    <WasteToursContent
      ...
      allTours={controller.overview?.tours ?? []}
      ...
      onReloadOverview={controller.reloadOverview}
      ...
      onUpdateTourStatusBulk={controller.onUpdateTourStatusBulk}
      canDuplicateTour={canDuplicateTour}
      canManageScheduling={canManageScheduling}
      canTransferAnnualTours={canDuplicateTour && canManageScheduling}
      search={search}
      saving={controller.saving}
      page={search.page}
      pageSize={search.pageSize}
      query={search.q}
      status={search.tourStatus}
