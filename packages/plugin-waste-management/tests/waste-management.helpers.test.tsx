...
vi.mock('@sva/plugin-sdk', () => ({
  formatDateTimeInEditorTimeZone: (value?: string) => {
    if (!value) {
      return value;
    }

    return value === '2026-05-10T10:00:00.000Z' ? '10.05.2026, 12:00' : value;
  },
...
describe('waste management helper modules', () => {
  ...
  it('covers page support helpers, download templates, and the reset dialog shell', () => {
    ...
    expect(formatUpdatedAt('2026-05-10T10:00:00.000Z')).toBe('10.05.2026, 12:00');
